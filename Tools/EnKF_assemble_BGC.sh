...
\n\
Example:\n\
\t EnKF_assemble_BGC.sh Forecast/ENSrestart2007_289_00.a Forecast/ENSrestart2007_289_00ICE.uf  3 4
\n\n\
NB:\n\
...
prog="$(dirname $0)/EnKF_assemble_BGC"
...
$prog $@
[ $? -ne 0 ]  && { echo EnKF_assemble_BGC failed ; exit 1 ; }
