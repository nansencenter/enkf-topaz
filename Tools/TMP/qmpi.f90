...
module qmpi
!
! A module defining a minimalist interface to a subset of 1.
...
!      1 will fail if the size of the object received is different from what
!      was sent.
!  
...
contains
  ...
  subroutine start_mpi()
!
! initialize the core 1 subsystem
! this routine should be called as the first statement in the program.
! 1 does not specify what happen before MPI_init and after mpi_finalize
!
    implicit none
