module m_read_HYCOM_SST_grid
  ! Reads the CLS SST NetCDF dimensions
contains
  subroutine read_HYCOM_SST_grid(filename,gr)
    !use mod_dimensions
    use mod_grid
    use nfw_mod
    implicit none
  ...
  end subroutine read_HYCOM_SST_grid
  
end module m_read_HYCOM_SST_grid
